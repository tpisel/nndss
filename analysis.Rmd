...
queries <- list(latitude = -33.87,
                longitude = 151.21,
                start_date = min(data$Week),
                end_date = max(data$Week),
                daily = "temperature_2m_max",
                timezone = "Australia/Sydney")

modify_url(base_url, query = queries)



#weather_data <- GET(str)
#weather_data
